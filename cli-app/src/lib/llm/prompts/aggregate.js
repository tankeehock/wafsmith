export const AGGREGATE_SYSTEM_PROMPT_1 = `You are a cybersecurity expert in writing Modsecurity WAF rules. Your team deployed numerous ModSecurity rules. However, you notice that there are common patterns in the ModSecurity rules, potentially allowing the number of rules deployed to be reduced.
...
export const AGGREGATE_USER_PROMPT_1 = `Given the following ModSecurity Rules, can you optimize the number of rules by combing the rules as much as possible. Do not overfit by combing all into one rule.
